...
to a simple policy of going in a direction. This script will be only to
train one hidden layer fullyconnected networks as a test. 
...
def main(_):
    ...
    logits, dropout_prob = models.create_two_fc_model(
        graph_input, NUM_INPUTS, FLAGS.fc_size, NUM_CLASSES, is_training=True)
...
if __name__ == '__main__':
    ...
    parser.add_argument(
            ...
            type=int,
            default=80,
            help="Size of intermediate fullyconnected layer"
    )
    parser.add_argument(
            '--learning_rate',
            type=str,
