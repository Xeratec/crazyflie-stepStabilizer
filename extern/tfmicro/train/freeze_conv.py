...
def create_inference_graph():
    ...
    logits = models.create_conv_model(
        reshaped_input,
        FLAGS.num_inputs, FLAGS.history_size,
        FLAGS.num_outputs,
        is_training=False)
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        ...
        default=4)
    parser.add_argument(
        '--history_size', type=int, dest='history_size',
        help='number of previous measurements to use, second dim of conv net input',
        required=True)
    parser.add_argument(
